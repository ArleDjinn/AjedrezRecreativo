...
class Purchase(db.Model):
    ...
    total_amount = db.Column(db.Integer, nullable=False)  # CLP
    ...
    # pending / paid / failed / expired  (y si quieres: cancelled)
    ...
    event = db.relationship("Event", backref=db.backref("purchases", lazy=True))
